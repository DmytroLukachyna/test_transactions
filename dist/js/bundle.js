...
function main() {
  document.querySelector('.header__close').addEventListener('click', function () {
    alert('Yeah, generally it should close something, but this test task does not require any logic, right? =) Anyway, if you see this – I am glad that you have found it, thanks for your time, I really appreciate it.');
  });
  document.querySelector('.main__item-dropdown').addEventListener('click', function () {
  ...
  document.querySelectorAll('.main__item-dropdown-option').forEach(function (e) {
    e.addEventListener('click', function () {
      document.querySelector('.main__item-dropdown span').textContent = e.textContent;
    });
  });
  document.querySelectorAll('.main__radio').forEach(function (e) {
    e.addEventListener('click', function () {
